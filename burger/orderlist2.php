...
<center><h1 class="font-weight-bold">LIST ORDER</h1>
<h3>-------------------------</h3>
<br>
...
while ($data = mysqli_fetch_array($sql)){
    ...
    echo "<td><button><a href='edit2.php?id=".$data['id']."'>Ubah<a></button>
        <button><a href='delete2.php?id=".$data['id']."'>Hapus<a></button></td>";
        echo "</tr>";
}
?>
</table>
<br>
<br>
    <a href="pengisian2.php">Add New User</a><br>
    <a href="index2.php">Kembali Ke Home</a><br/><br/></center>
